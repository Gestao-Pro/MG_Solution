...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onSave, initialProfile }) => {
    ...
    // Merge defaults to avoid uncontrolled -> controlled warnings when fields are undefined
    const [profile, setProfile] = useState<UserProfile>(initialProfile ? { ...defaultProfile, ...initialProfile } : defaultProfile);
